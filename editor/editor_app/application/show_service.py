...
async def show_doc(repo, collection: str, doc_id: str, params: Mapping[str, str], q: Optional[str]) -> Tuple[Optional[Dict[str, Any]], Optional[str], Optional[str], str]:
    ...
    filt_nav = build_filter(q or "", collection, params)
