...
Il background del tuo personaggio è un insieme di caratteristiche che rappresentano il luogo e l’occupazione che hanno avuto il maggiore impatto formativo prima che intraprendesse una vita d’avventura.

### Parti di un Background

Un background include le seguenti parti.

#### Punteggi di Caratteristica

Un background elenca tre punteggi di caratteristica del tuo personaggio. Aumentane uno di 2 e un altro di 1, oppure aumenta tutti e tre di 1. Nessuno di questi aumenti può portare un punteggio oltre 20.

#### Talento

Un background conferisce al tuo personaggio un talento di Origine specificato (descritto in “Talenti”).

#### Competenza in Abilità

Un background conferisce al tuo personaggio competenza in due abilità specificate.

#### Competenza negli Strumenti

Ogni background conferisce a un personaggio competenza in uno strumento—uno specifico o scelto dalla categoria Strumenti da Artigiano. Gli strumenti sono descritti in “Equipaggiamento”.

#### Equipaggiamento

Ogni background offre una scelta tra un pacchetto di equipaggiamento e 50 mo.
