...
I talenti che seguono sono organizzati per categoria— Origine, Generale, Stile di Combattimento o Dono Epico—e in ordine alfabetico all’interno di ciascuna categoria.

### Parti di un Talento

La descrizione di un talento contiene le seguenti parti, presentate dopo il nome del talento.

**Categoria.** Un talento appartiene a una categoria, indicata nella descrizione. Se ti viene richiesto di scegliere un talento da una categoria specifica, come quella di Origine, quella categoria deve apparire sotto il nome del talento. Se ti viene richiesto di scegliere un talento senza specificare la categoria, puoi sceglierlo da qualsiasi categoria.

**Prerequisito.** Per acquisire un talento, devi soddisfare ogni prerequisito elencato nella sua descrizione, a meno che una caratteristica non ti permetta di prenderlo senza rispettare i prerequisiti. Se un prerequisito include una classe, devi avere almeno 1 livello in quella classe per acquisire il talento.

**Beneficio.** I benefici di un talento sono descritti dopo i prerequisiti. Se possiedi un talento, ottieni i suoi benefici.

**Ripetibile.** Un talento può essere acquisito solo una volta, a meno che la sua descrizione non indichi diversamente in una sottosezione “Ripetibile”.
